...
class AqidahrumayshoSpider(scrapy.Spider):
    ...
    start_urls = ['https://muslim.or.id/category/fiqh-dan-muamalah']
    

    def start_requests(self):
        urls = ['https://muslim.or.id/category/fiqh-dan-muamalah']
        for url in urls:
    ...
    def parse(self, response):
        for i in range(2,76):
            ...
            next_page_url = 'https://muslim.or.id/category/fiqh-dan-muamalah/page/'
