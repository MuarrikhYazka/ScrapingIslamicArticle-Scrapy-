...
class AqidahrumayshoSpider(scrapy.Spider):
    name = 'gayahidupsharia'
    allowed_domains = ['sharianews.com']
    start_urls = ['https://sharianews.com/category/lifestyle']
    

    def start_requests(self):
        urls = ['https://sharianews.com/category/lifestyle']
        for url in urls:
    ...
    def parse(self, response):
        for i in range(2,57):
            ...
            next_page_url = 'https://sharianews.com/category/lifestyle?page='
    ...
    def parse2(self, response):
        ...
        item['teks'] = response.xpath(".//div[contains(@class, '__space')]/div[contains(@class, '__content')]//p/span/text()").extract()
