...
class AqidahrumayshoSpider(scrapy.Spider):
    ...
    start_urls = ['https://rumaysho.com/category/belajar-islam/aqidah/']
    

    def start_requests(self):
        urls = ['https://rumaysho.com/category/belajar-islam/aqidah/']
        for url in urls:
    ...
    def parse(self, response):
        for i in range(2,24):
            ...
            next_page_url = 'https://rumaysho.com/category/belajar-islam/aqidah/page/'
