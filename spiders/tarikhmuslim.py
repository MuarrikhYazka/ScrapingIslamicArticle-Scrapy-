...
class AqidahrumayshoSpider(scrapy.Spider):
    ...
    start_urls = ['https://muslim.or.id/category/sejarah-islam']
    

    def start_requests(self):
        urls = ['https://muslim.or.id/category/sejarah-islam']
        for url in urls:
    ...
    def parse(self, response):
        for i in range(2,7):
            ...
            next_page_url = 'https://muslim.or.id/category/sejarah-islam/page/'
