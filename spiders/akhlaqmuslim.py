...
class AqidahrumayshoSpider(scrapy.Spider):
    ...
    start_urls = ['https://muslim.or.id/category/akhlaq-dan-nasehat']
    

    def start_requests(self):
        urls = ['https://muslim.or.id/category/akhlaq-dan-nasehat']
        for url in urls:
    ...
    def parse(self, response):
        for i in range(2,54):
            ...
            next_page_url = 'https://muslim.or.id/category/akhlaq-dan-nasehat/page/'
